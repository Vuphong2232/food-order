<section class="hero-bg relative pt-10 pb-10 overflow-hidden">
    ...
    <div class="px-8 relative z-10">
        <div class="max-w-2xl animate-fade-in-up">
            ...
            <p class="text-brown-500 text-base leading-relaxed max-w-lg">
                Khám phá các món ăn ngon được chế biến từ nguyên liệu tươi ngon nhất, giao tận nơi.
            </p>
        </div>
    </div>
</section>